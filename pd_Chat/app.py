...
def display_header() -> None:
    st.image("img/pdfchat2.jpg", width = 700, use_column_width = True)
...
def main() -> None:
    ...
    display_video_and_music_player('video/charming_boy.mp4', 'musique/Boys (Summertime Love) - Sabrina (Salerno) - backingtrackx.com.mp3')
